...
set_property PACKAGE_PIN W5 [get_ports {board_clk_i}]							
	set_property IOSTANDARD LVCMOS33 [get_ports {board_clk_i}]
...
set_property PACKAGE_PIN U18 [get_ports btnC_async_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnC_async_i]
set_property PACKAGE_PIN T18 [get_ports btnU_async_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnU_async_i]
set_property PACKAGE_PIN W19 [get_ports btnL_async_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnL_async_i]
set_property PACKAGE_PIN T17 [get_ports btnR_async_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnR_async_i]
set_property PACKAGE_PIN U17 [get_ports btnD_async_i]						
	set_property IOSTANDARD LVCMOS33 [get_ports btnD_async_i]
...
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_red_o[3]}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {hdmi_red_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_red_o[1]}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {hdmi_green_o[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_green_o[3]}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {hdmi_green_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_green_o[1]}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {hdmi_red_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_red_o[2]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {hdmi_red_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_red_o[0]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {hdmi_green_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_green_o[2]}]
##Sch name = JB10
set_property PACKAGE_PIN C16 [get_ports {hdmi_green_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_green_o[0]}]

##Pmod Header JC
##Sch name = JC1
set_property PACKAGE_PIN K17 [get_ports {hdmi_blue_o[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_blue_o[3]}]
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {hdmi_clk_o}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_clk_o}]
##Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {hdmi_blue_o[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_blue_o[0]}]
##Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {hdmi_hsync_o}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_hsync_o}]
##Sch name = JC7
set_property PACKAGE_PIN L17 [get_ports {hdmi_blue_o[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_blue_o[2]}]
##Sch name = JC8
set_property PACKAGE_PIN M19 [get_ports {hdmi_blue_o[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_blue_o[1]}]
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {hdmi_dispen_o}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_dispen_o}]
##Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {hdmi_vsync_o}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_vsync_o}]
